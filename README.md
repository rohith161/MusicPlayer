...
The project is actively being developed. Features, UI, playback architecture, and device compatibility may continue to evolve.
...
4. Connect an Android device or start an emulator running Android 8.0 or later.
